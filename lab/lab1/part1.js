...
===================== */
//because it's already year 2021, I change age(1971) === 50

var age = function(birth) { return new Date().getFullYear() - birth};

console.log('age success:', age(1971) === 50);
...
var valueAtKey = function(object) {return object[Object.keys(object)]};
...
var y = function(m, x, b) {return y = m * x + b};
