...
var plusOne = function(num) {var answer = num + 1;
return answer};
...
var age = function(birth) {var age = 2020-birth;
return age};
...
var over9000 = function(num) {if (num > 9000) return true;
else return false };
...
var valueAtKey = function(object, key) {return object[key]
};
...
var y = function(m,x,b) {var y = m*x+b;
return y};
