...
var justFalse = function() {return 1===2};
...
var not = function(bl) {return bl != bl};
...
var isOdd = function(num) {not(isEven(num))};
...
var filterOutLessThan10 = function(list) {
  ...
  for(i = 0; i <list.length; i++){
    if(list[i] > 10) {listbigger10.push(list[i])}
  }
  return listbigger10
};
...
var filter = function(array, func) {
  ...
  for(i = 0; i < array.length; i++){
    if(func(array[i] == true)) {odd.push(array[i])}
  }
  return odd
};
