...
var largeStationList = _.filter(data, dock => dock[3] > 20 );

console.log('large station list:', largeStationList);

var largeStationCount = _.countBy(data, dock => dock[3] > 20 ? 'large':'small')['large'];

console.log('large station count', largeStationCount);
